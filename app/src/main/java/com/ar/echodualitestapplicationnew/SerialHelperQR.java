...
public abstract class SerialHelperQR {
    ...
    //----------------------------------------------------
    public SerialHelperQR(String sPort, int iBaudRate){
        this.sPort = sPort;
        this.iBaudRate=iBaudRate;
    }
    public SerialHelperQR(){
        this("/dev/s3c2410_serial0",9600);
    }
    public SerialHelperQR(String sPort){
        this(sPort,9600);
    }
    public SerialHelperQR(String sPort, String sBaudRate){
    ...
    private class ReadThread extends Thread {
        ...
        public void run() {
            ...
            while(!stopCond) {
                ...
                {
                    Thread.sleep(50);
                    barcodeScanner.BarcodeScanner_Trigger(false);
                    ...
                    Thread.sleep(50);
                    barcodeScanner.BarcodeScanner_Trigger(true);
                } catch (Exception e) {

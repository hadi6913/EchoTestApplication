...
public abstract class SerialHelperReader {
    ...
    //----------------------------------------------------
    public SerialHelperReader(String sPort, int iBaudRate){
        this.sPort = sPort;
        this.iBaudRate=iBaudRate;
    }
    public SerialHelperReader(){
        this("/dev/s3c2410_serial0",9600);
    }
    public SerialHelperReader(String sPort){
        this(sPort,9600);
    }
    public SerialHelperReader(String sPort, String sBaudRate){
